...
a function equivalent to `y -> y in collection`. See also [`insorted`](@ref) for the use
...
The returned function is of type `Base.Fix2{typeof(ni)}`.
"""
ni(x) = Fix2(ni, x)
